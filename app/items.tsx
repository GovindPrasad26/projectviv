...
//       if (res.ok) Alert.alert("✅ Success", `${item.itemName} added to cart!`);
//       else Alert.alert("❌ Error", data.message || "Failed to add item");
//     } catch (err) {
//       console.log(err);
...
import React, { useEffect, useState, useContext } from "react";
import {
  View, Text, FlatList, StyleSheet, Image, TouchableOpacity, TextInput, ActivityIndicator, StatusBar, Alert,
} from "react-native";
import { useSelector } from "react-redux";
